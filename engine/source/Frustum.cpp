...
//
//
//void CFrustum::NormalizeFrustum()
//{
...
//
//
//bool CFrustum::isPointVisiable(float x, float y, float z)
//{
...
//
//
//bool CFrustum::isSphereVisiable(float x, float y, float z, float radius)
//{
//   float distance = 0;
//
//   // Test all sides of the frustum planes.
...
//
//
//bool CFrustum::isBoxVisiable(float x, float y, float z, float size)
//{
//   float minX, maxX;
//   float minY, maxY;
//   float minZ, maxZ;
