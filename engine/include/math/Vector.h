...
struct Vector2Type {
    ...
    Vector2Type<T> operator*(T scale) {
        Vector2Type<T> res;
        res.x = x * scale;
        res.y = y * scale;
        return res;
    ...
    Vector2Type<T>& operator*=(const Vector2Type<T>& rhs) {
        this->x *= rhs.x;
        this->y *= rhs.y;
...
struct Vector3Type {
    ...
    Vector3Type<T>& operator+=(const Vector2Type<T>& rhs) {
        this->x += rhs.x;
        this->y += rhs.y;
...
typedef Vector4Type<int32_t> Vector4i;
